<template>
  <div class="flex h-screen">
    <!-- Main Content -->
    <main class="bg-slate-200 flex flex-col w-full p-6">
      <div>
        <div class="">
          <div class="card">
            ...
            <div class="flex items-center space-x-4 pb-5">
              <div class="card w-full">
                ...
                >
                  ...
                  <template #end>
                    <template v-if="Cookies.get('access_token')">
                      <Button
                        label="Logout"
                        icon="pi pi-sign-out"
                        @click="handleLogout"
        ...
        <div class="flex justify-between items-center">
          <div class="mb-2">
            <div class="relative">
              <input placeholder="Search" class="p-2 rounded-xl w-96 pl-10" />
              <i
                class="pi pi-search absolute left-3 top-1/2 transform -translate-y-1/2"
              ></i>
            </div>
          </div>
          <div class="flex space-x-2 mr-60">
            <i class="pi pi-envelope bg-white p-2 rounded-full"></i>
            <i class="pi pi-bell bg-white p-2 rounded-full"></i>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div class="inline-flex flex-col gap-2">
                  ...
                  <InputText
                    id="username"
                    v-model="username"
                    class="!bg-white/20 !border-0 !p-4 !text-primary-50 w-80 !text-white"
                  ></InputText>
                </div>
                <div class="inline-flex flex-col gap-2">
                  <label
